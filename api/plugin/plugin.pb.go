...
type ScanResponse struct {
	...
	// References to external documents discovered during scanning.
	// Providers MAY populate this when they encounter mapping references
	// not present in the policy metadata (e.g., from complypack content
	// or provider-specific knowledge). These are merged with policy-level
	// mapping references by complyctl, with policy entries taking priority
	// on id collisions.
	MappingReferences []*MappingReference `protobuf:"bytes,3,rep,name=mapping_references,json=mappingReferences,proto3" json:"mapping_references,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *ScanResponse) GetMappingReferences() []*MappingReference {
	if x != nil {
		return x.MappingReferences
	}
	return nil
}

// MappingReference represents a reference to an external document
// with full metadata. Mirrors go-gemara MappingReference.
type MappingReference struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// id identifies this mapping reference within the artifact and,
	// when url is absent, the referenced artifact's metadata.id.
	...
	// url is the path where the artifact may be retrieved; preferably
	// responds with Gemara-compatible YAML/JSON
	Url           string `protobuf:"bytes,5,opt,name=url,proto3" json:"url,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *MappingReference) Reset() {
	*x = MappingReference{}
...
func (x *MappingReference) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MappingReference) ProtoMessage() {}

func (x *MappingReference) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MappingReference.ProtoReflect.Descriptor instead.
func (*MappingReference) Descriptor() ([]byte, []int) {
	return file_plugin_proto_rawDescGZIP(), []int{6}
}

func (x *MappingReference) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *MappingReference) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *MappingReference) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
func (x *MappingReference) GetDescription() string {
	if x != nil {
...
func (x *MappingReference) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *AssessmentLog) GetEvidence() []*Evidence {
	if x != nil {
		return x.Evidence
	}
	return nil
...
func (x *AssessmentLog) GetRecommendation() string {
	if x != nil {
...
func (x *Evidence) GetCollectedAt() string {
	if x != nil {
...
const file_plugin_proto_rawDesc = "" +
	"\n" +
	"\fplugin.proto\x12\x13complyctl.plugin.v1\"\xf3\x03\n" +
	...
	"\x12mapping_references\x18\x03 \x03(\v2%.complyctl.plugin.v1.MappingReferenceR\x11mappingReferences\"\x86\x01\n" +
	"\x10MappingReference\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12\x18\n" +
	"\aversion\x18\x03 \x01(\tR\aversion\x12 \n" +
	"\vdescription\x18\x04 \x01(\tR\vdescription\x12\x10\n" +
	"\x03url\x18\x05 \x01(\tR\x03url\"\xaa\x02\n" +
	"\rAssessmentLog\x12%\n" +
	...
	"confidence\x129\n" +
	"\bevidence\x18\x05 \x03(\v2\x1d.complyctl.plugin.v1.EvidenceR\bevidence\x12&\n" +
	"\x0erecommendation\x18\x06 \x01(\tR\x0erecommendation\"i\n" +
	"\x04Step\x12\x12\n" +
...
var file_plugin_proto_goTypes = []any{
	...
	(*MappingReference)(nil),        // 8: complyctl.plugin.v1.MappingReference
	(*AssessmentLog)(nil),           // 9: complyctl.plugin.v1.AssessmentLog
	(*Step)(nil),                    // 10: complyctl.plugin.v1.Step
	(*EvidenceMapping)(nil),         // 11: complyctl.plugin.v1.EvidenceMapping
	(*Evidence)(nil),                // 12: complyctl.plugin.v1.Evidence
	(*DescribeRequest)(nil),         // 13: complyctl.plugin.v1.DescribeRequest
	(*DescribeResponse)(nil),        // 14: complyctl.plugin.v1.DescribeResponse
...
var file_plugin_proto_depIdxs = []int32{
	...
	9,  // 6: complyctl.plugin.v1.ScanResponse.assessments:type_name -> complyctl.plugin.v1.AssessmentLog
	8,  // 7: complyctl.plugin.v1.ScanResponse.mapping_references:type_name -> complyctl.plugin.v1.MappingReference
	10, // 8: complyctl.plugin.v1.AssessmentLog.steps:type_name -> complyctl.plugin.v1.Step
	0,  // 9: complyctl.plugin.v1.AssessmentLog.confidence:type_name -> complyctl.plugin.v1.ConfidenceLevel
	12, // 10: complyctl.plugin.v1.AssessmentLog.evidence:type_name -> complyctl.plugin.v1.Evidence
	1,  // 11: complyctl.plugin.v1.Step.result:type_name -> complyctl.plugin.v1.Result
	11, // 12: complyctl.plugin.v1.Evidence.source:type_name -> complyctl.plugin.v1.EvidenceMapping
	2,  // 13: complyctl.plugin.v1.Plugin.Generate:input_type -> complyctl.plugin.v1.GenerateRequest
	5,  // 14: complyctl.plugin.v1.Plugin.Scan:input_type -> complyctl.plugin.v1.ScanRequest
	13, // 15: complyctl.plugin.v1.Plugin.Describe:input_type -> complyctl.plugin.v1.DescribeRequest
	...
	14, // 18: complyctl.plugin.v1.Plugin.Describe:output_type -> complyctl.plugin.v1.DescribeResponse
